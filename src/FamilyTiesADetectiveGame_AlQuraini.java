...
JAVADOC IN THE STORY RELATED CLASSES WILL BE MINIMAL AND WILL ONLY EXPLAIN HOW CERTAIN VARIABLES INFLUENCE THE PROGRESSION OF THE GAME.
...
class Chapter1 extends Chapter{
   ...
   public boolean check1(){
      System.out.println("");
      dPrint("              FRIDAY, DECEMBER 8th 2022 - 11:48pm - Your House");
      System.out.println("");
      ...
      ePrint(evidence);
      System.out.println("");
      dPrint("                   CHAPTER 1 - The Examination");
      System.out.println("");
   ...
   public boolean check2(){
      ...
      System.out.println("");
      dPrint("Would you like to meet with the boyfriend? \n[1] Yes \n[2] No");
      System.out.println("");
      while (pInputFail == true){
         System.out.print("Enter your answer here: ");
         pInput = input.nextLine();
